...
public class CriaExcel {
	...
	public static void main(String[] args) throws IOException {
		...
		/**
		 * O primeiro passo, é criar o arquivo, com a classe HSSFWorkbook, e depois
		 * criar a planilha com a classe HSSFSheet, é possível nomear essa planilha, no
		 * exemplo, a planilha é chamada de Alunos.
		 */
		...
		/**
		 * Depois de criada a planilha, é feito um for que itera sobre a lista onde os
		 * alunos estão cadastrados. A cada aluno que existe na lista, é criada uma
		 * linha no arquivo excel, e para cada célula dessa linha são adicionados os
		 * atributos do aluno, na mesma ordem do arquivo utilizado no exemplo para a
		 * leitura dos dados.
		 */
		int rownum = 0;
		...
		try {
			/**
			 * Por fim, é dado um nome para o arquivo, utilizando a classe FIleOutputStream,
			 * e os dados do criados para a planilha são salvos no arquivo.
			 */
